...
from metaworld.envs.mujoco.sawyer_xyz.v2 import (
    ...
    SawyerButtonPressTopdown2EnvV2,
    SawyerButtonPressTopdownWall2EnvV2,
    SawyerDrawerClose2EnvV2,
    SawyerDrawerOpen3EnvV2,
    SawyerWindowOpen3EnvV2,
)
...
ALL_V2_ENVIRONMENTS = OrderedDict((
    ...
    ('button-drawer-v2', SawyerButtonDrawerEnvV2),
    ('button-window-v2', SawyerButtonWindowEnvV2),
    ('drawer-window-v2', SawyerDrawerWindowEnvV2),
    ('random2object-v2', SawyerRandom2ObjectEnvV2),
    ('button-press2-v2', SawyerButtonPress2EnvV2),
    ('door-close2-v2', SawyerDoorClose2EnvV2),
    ('door-open2-v2', SawyerDoor2EnvV2),
    ('drawer-open2-v2', SawyerDrawerOpen2EnvV2),
    ('window-close2-v2', SawyerWindowClose2EnvV2),
    ('window-open2-v2', SawyerWindowOpen2EnvV2),
    ('button-press-topdown2-v2', SawyerButtonPressTopdown2EnvV2),
    ('button-press-topdown-wall2-v2', SawyerButtonPressTopdownWall2EnvV2),
    ('drawer-close2-v2', SawyerDrawerClose2EnvV2),
    ('drawer-open3-v2', SawyerDrawerOpen3EnvV2),
    ('window-open3-v2', SawyerWindowOpen3EnvV2),
))
