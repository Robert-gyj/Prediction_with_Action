...
class SawyerDrawerOpen3EnvV2(SawyerXYZEnv):
    def __init__(self):
    ...
    @property
    def model_name(self):
        return full_v2_path_for('sawyer_xyz/sawyer_a_drawer3.xml')
    ...
    def evaluate_state(self, obs, action):
        ...
        info = {
            'success': float(handle_error <= 0.03 and gripper_error <= 0.06),
            'near_object': float(gripper_error <= 0.06),
