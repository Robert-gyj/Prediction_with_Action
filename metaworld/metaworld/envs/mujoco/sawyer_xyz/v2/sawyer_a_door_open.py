...
class SawyerDoor2EnvV2(SawyerXYZEnv):
    def __init__(self):
    ...
    @property
    def model_name(self):
        return full_v2_path_for('sawyer_xyz/sawyer_a_door_pull.xml')
    ...
    def compute_reward(self, actions, obs):
        ...
        reward_grab = SawyerDoor2EnvV2._reward_grab_effort(actions)
        reward_steps = SawyerDoor2EnvV2._reward_pos(obs, theta)
