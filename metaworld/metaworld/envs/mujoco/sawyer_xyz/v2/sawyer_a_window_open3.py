...
class SawyerWindowOpen3EnvV2(SawyerXYZEnv):
    """
    Motivation for V2:
    ...
    def __init__(self):
        ...
        hand_high = (0.5, 1, 0.5)
        obj_low = (0.05, 0.7, 0.16)
        obj_high = (0.2, 0.85, 0.16)
        #obj_high = (0.2, 0.7, 0.16)
        super().__init__(
            self.model_name,
            hand_low=hand_low,
            hand_high=hand_high,
    ...
    @property
    def model_name(self):
        return full_v2_path_for('sawyer_xyz/sawyer_a_window_horizontal3.xml')
